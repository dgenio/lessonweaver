...
Closed-loop effectiveness reports and per-skill review scorecards are available
through the library API; see [closed-loop effectiveness](docs/effectiveness.md).
